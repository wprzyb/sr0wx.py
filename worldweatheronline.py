...
def getData(l):
    ...
    f0w = weather['data']['weather'][0]['hourly'][0]
    f1 = weather['data']['weather'][1]
    f1w = weather['data']['weather'][1]['hourly'][0]
    ...
    data = {
        ...
        #'FCAST0_TEMP_MIN_F':int(f0['mintempF']),
        #'FCAST0_TEMP_MAX_F':int(f0['maxtempF']),
        'FCAST0_WEATHER':lang.removeDiacritics(wc[f0w['weatherCode']], remove_spaces=True),
        'FCAST0_WIND_DIR':wind_direction(f0w['winddir16Point']),
        'FCAST0_WIND_DIR_DEG':lang.cardinal(int(f0w['winddirDegree']),lang.deg),
        'FCAST0_WIND_SPEED_KMPH':lang.cardinal(int(f0w['windspeedKmph']),lang.kmPh),
        'FCAST0_WIND_SPEED_MPS':lang.cardinal(kmph2mps(int(f0w['windspeedKmph'])),lang.mPs),
        'FCAST0_WIND_SPEED_MI':int(f0w['windspeedMiles']),
        ...
        #'FCAST1_TEMP_MIN_F':int(f1['mintempF']),
        #'FCAST1_TEMP_MAX_F':int(f1['maxtempF']),
        'FCAST1_WEATHER':lang.removeDiacritics(wc[f1w['weatherCode']], remove_spaces=True),
        'FCAST1_WIND_DIR':wind_direction(f1w['winddir16Point']),
        'FCAST1_WIND_DIR_DEG':lang.cardinal(int(f1w['winddirDegree']),lang.deg),
        'FCAST1_WIND_SPEED_KMPH':lang.cardinal(int(f1w['windspeedKmph']),lang.kmPh),
        'FCAST1_WIND_SPEED_MPS':lang.cardinal(kmph2mps(int(f1w['windspeedKmph'])),lang.mPs),
        'FCAST1_WIND_SPEED_MI':int(f1w['windspeedMiles']),
    }
